...
- [[../04_Code/revised/README|Revised Notebooks]]
- `ML1_homework.ipynb`
- `Modeling.ipynb`
...
- [ ] 准备并核验真实交易日历、样本范围和数据版本
- [ ] 运行 revised 数据处理 Notebook，检查质量报告和时间划分
- [ ] 运行 revised 模型 Notebook，只使用 Validation 完成研究决策
- [ ] 运行 Validation 回测并冻结信号阈值与成本口径
- [ ] 研究设计冻结后单次运行最终 Test，并记录结果与限制
...
- 模型预测结果：[[../04_Code/02_model_training/README|Modeling.ipynb]]
- 策略回测结果：[[../04_Code/03_backtest/README|Modeling_Backtest.ipynb]]
